export interface Config {
  ...
  CONVERT_MAX_UPLOAD_IMAGE_BYTES: number;
  CONVERT_IMAGE_MAX_WIDTH: number;
  CONVERT_IMAGE_MAX_HEIGHT: number;
  CONVERT_IMAGE_MAX_PIXELS: number;
  CONVERT_IMAGE_QUALITY_DEFAULT: number;
}
